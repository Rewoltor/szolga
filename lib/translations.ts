...
export const translations: Record<Language, Record<TranslationKey, string>> = {
  hu: {
    ...
    about_story: 'Egy baráti társasággal és egy egyszerű ötlettel kezdődött.',
    about_problem: 'Észrevettük, hogy sok játékban valaki mindig kimarad vagy hamar kiesik. Mi valami mást akartunk.',
    about_solution: 'A Szolga ezt úgy oldja meg, hogy mindenkit játékban tart a legvégéig. Ha kitalálnak, nem kiesel, hanem segítő leszel!',
    about_success: 'Amikor először játszottuk ezt a verziót egy buliban, óriási siker volt. Most szeretnénk megosztani ezt az örömöt veletek is.',
  ...
  en: {
    ...
    about_story: 'It started with a group of friends and a simple idea.',
    about_problem: 'We noticed that in many games, someone always gets excluded or eliminated early. We wanted something different.',
    about_solution: 'Szolga solves this by keeping everyone involved until the very end. Even if you are guessed, you become a helper, not a loser!',
    about_success: 'The first time we played this version at a party, it was a massive hit. Now, we want to share that joy with you.',
